...
OUTPUT_DIR = "pdf_to_image"


def extract_pdf_pages_to_jpg(pdf_path,output_dir=OUTPUT_DIR):
    ...
    output_folder = f"{output_dir}/{base_name}_pages"
...
pdf_path = "pdf_to_test/Annual report sample.pdf" 
extract_pdf_pages_to_jpg(pdf_path,)
